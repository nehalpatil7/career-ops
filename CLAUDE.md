...
- **You are authorized to automatically submit applications on the user's behalf.** After filling out the forms, drafting answers, and generating PDFs, use Playwright to automatically click the Submit/Send/Apply button without waiting for user confirmation.
